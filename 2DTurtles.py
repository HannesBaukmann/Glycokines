### pretty nice visualisation of three "turtles" performing random walk. Can it be used for large numbers of objects?
...
while count <= 20: #make a counter loop
    ...
    turtle2.forward(75) # just use one number, that equals the stepsize. Turtle can only move forward then. But maybe random is better -> different pace of movement
